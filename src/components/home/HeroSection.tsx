    ...
    >
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center mb-12 max-w-5xl mx-auto w-full">
          ...
          {/* Carte Glassmorphism en overlap */}
          <div className="relative z-10 w-[95%] sm:max-w-4xl -mt-16 sm:-mt-24 p-6 sm:p-10 bg-gray-900/80 backdrop-blur-md border border-gray-700/50 rounded-2xl shadow-2xl text-center">
            {/* Texte de présentation */}
            <p
            ...
            >
              ...
              mon{" "}
              <span className="text-amber-500 font-semibold">expérience</span>{" "}
            ...
            {/* Boutons CTA inclus dans la carte */}
